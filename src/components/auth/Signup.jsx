...
function Signup() {
  ...
  return (
    <div className="w-full h-screen flex font-poppins">
      <div className='flex-[45%] h-full rounded-e-xl flex flex-col '
      style={{ backgroundImage: `url(${Sidebar_Bg})`, backgroundSize: 'cover' }}>
      ...
      <div className='flex-[55%] bg-primary-bg-color h-full py-24 pl-20 pr-44'>
        {
          step === 1 ?(<div className='w-full h-full bg-white  px-20 flex justify-center rounded-lg border-[2px] border-[#E9EBEE] items-center flex-col'>
            <h1 className='text-4xl text-center  font-semibold text-primary-title-color pb-[15px] pt-[20px]'>Get Started</h1>
            <p className='text-[16px] text-primary-color text-center pb-[36px]'>Create Your Account and Simplify Your Payments!</p>
...
{errors && <p className='text-[12px] text-red-600 py-2'>Email is already exist.</p>
              ...
              <div className='text-[16px] flex text-center gap-1 justify-center pt-[28px]'>
                ...
                <Link to="/auth/login" className='text-[#3CA7FF]/85 font-semibold underline'>Login</Link>
              </div>
            </div>
          </div>):
