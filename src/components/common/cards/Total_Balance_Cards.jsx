  ...
  return (
    <div className='w-full bg-white p-[24px] rounded-[12px] border border-[#E9EBEE] text-primary-title-color font-poppins '>
        ...
        <div className='gap-[10px] flex'>
          <Link to="/my-cards" className='flex justify-center items-center gap-2 flex-[60%] bg-primary-button-gradient text-white rounded-lg py-2 border hover:bg-primary-button-hover-gradient'>
